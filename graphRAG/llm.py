...
def generate_cypher_query(nl_query, context):
    """
    Uses OpenAI GPT-4o to generate a Cypher query from a natural language input.
    Ensures the query matches the actual Neo4j schema, avoiding incorrect labels or properties.
    """
    ...
    **Generated Cypher Query:**
    ...
    try:
        ...
        # 🛠️ Strip Markdown formatting (` ```cypher ... ``` `)
